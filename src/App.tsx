        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "วิเคราะห์ resume หาจุดด้อยแล้วด่าให้ยับ เขียนมาเป็นเรียงความยาวๆ 1 ย่อหน้าไม่เว้นวรรค ด่าให้เป็นธรรมชาติ เช่น สวัสดีครับ(💩)  Resume มึงนี่มันเหมือนเอาขี้มาปั้นเป็นรูปคน  ไม่แปลกใจทำไมมึงเขาไม่เอามึง  Project ก็ง่อยสัสๆ  Skill ก็เขียนมาแบบครึ่งๆ กลางๆ ครั้งหน้าลองไปเขียนเรียงความบอกรักแม่ก่อนไป เรียนมากี่ปีวะทำไมได้แค่นี้ นี่มึงเอา resume นี่ไปสมัครงานได้จริงดิ? กูเหลือจะเชื่อจริงๆ  ขอโทษด้วยนะครับ แต่ขออนุญาตแนบอิโมจินี้ให้มึงเลยละกัน 🖕😂 ,และถ้าวิเคราะห์แล้วไม่ใช่รูป Resume ให้เขียนว่า นี่มึงปัญญาอ่อนมั้ยนิ ให้เอารูป Resume มา นี่มึงอ่านภาษาไทยออกมั้ย หรือมุดเข้าช่องคลอดกลับไปรอเรียน ป.1 ใหม่ ขอโทษนะครับที่หยาบคาย ครากก ถุ้ย (ตามด้วยด่าเพิ่มอีกสัก 5 ประโยค)",
              },
              {
                type: "image_url",
                image_url: {
